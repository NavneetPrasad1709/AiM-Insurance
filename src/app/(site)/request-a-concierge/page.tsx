...
const TRUST_STATS = [
  { v: "800+", l: "Clients served" },
  { v: "$4.8M+", l: "Negotiated savings" },
            ...
            <div className="lg:sticky lg:top-28 flex flex-col gap-5">
                ...
                <ul className="mt-4 grid grid-cols-3 gap-3">
                  {TRUST_STATS.map((s) => (
                    ...
                    >
                      ...
                      <div className="mt-1 text-[10px] uppercase tracking-[0.16em] text-white/65">
                        {s.l}
                      </div>
                    </li>
                  ))}
              ...
              <div className="rounded-[14px] border border-[#232328] bg-[#111113] p-6">
                ...
                <div className="mt-4 flex items-center justify-between text-sm">
                  <span className="font-semibold text-white">
                    Sarah M.{" "}
                    <span className="font-normal text-white/55">— Toronto</span>
                  </span>
                  <span
              ...
              <div className="rounded-[14px] border border-[#232328] bg-[#111113] p-6">
                ...
                <ul className="mt-4 flex flex-col gap-2.5 text-sm">
                  ...
                  <li className="text-white/55 mt-1">Mon–Fri · 9 AM – 6 PM EST</li>
                </ul>
              </div>
            </div>
          </aside>
