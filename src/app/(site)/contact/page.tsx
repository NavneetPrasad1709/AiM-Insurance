  ...
  return (
    ...
    <div className="relative bg-background pt-12 pb-24 sm:pt-16 sm:pb-32 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-[1280px] px-5 sm:px-8 lg:px-12">
        ...
        <div className="mt-12 mb-10 max-w-2xl">
          <span className="inline-flex items-center gap-2 rounded-full border border-border bg-surface/80 backdrop-blur-md px-3.5 py-1.5 text-[11px] font-heading font-bold uppercase tracking-[0.2em] text-cta">
            <ICONS.MessageSquare className="size-3.5" aria-hidden />
            Send a message
          </span>
          <h2
            className="mt-4 font-heading font-extrabold text-white tracking-[-0.03em] leading-[1.05]"
