        ...
        >
          ...
          <div className="flex-1 overflow-y-auto px-6 pb-8">
                                ...
                                return (
                                  <li key={child.href}>
                                    <button
                                      ...
                                      className="w-full flex items-center gap-3 py-2.5 text-left text-lg text-white hover:text-cta transition-colors"
                                    >
                                      {Icon && (
                                        <Icon
            ...
            <a
              ...
              onClick={onClose}
              className="inline-flex items-center gap-3 text-white hover:text-cta transition-colors"
            >
              ...
              {SOCIAL_LINKS.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="inline-flex size-10 items-center justify-center rounded-full border border-white/20 text-white hover:text-cta hover:border-cta transition-colors"
                  >
