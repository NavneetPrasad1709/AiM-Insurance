    ...
    >
      ...
      <div className="flex gap-2">
        <input
          ...
          className="flex-1 min-w-0 rounded-full border border-white/15 bg-white/5 px-4 py-2.5 text-sm text-white placeholder:text-white/40 focus:outline-none focus:border-[#ffc83d] focus:ring-2 focus:ring-[#ffc83d]/30 disabled:opacity-60"
        />
        <button
          type="submit"
          disabled={isLoading || isSuccess}
          aria-label="Subscribe to newsletter"
          className="inline-flex items-center justify-center gap-1.5 rounded-full bg-[#ffc83d] hover:bg-[#ffd75a] text-[#0a0a0a] px-5 py-2.5 text-sm font-heading font-semibold transition-colors disabled:opacity-70"
        >
          {isLoading ? (
